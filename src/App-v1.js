  ...
  render() {
    return (
      <div className='app'>
        ...
        <div>
          <input type="text" name="" id="" placeholder='Search from location' value={this.state.location} onChange={(e) => this.setState({ location: e.target.value })} />
        </div>
